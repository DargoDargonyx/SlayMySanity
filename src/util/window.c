 ...
 * @author DargoDargonyx
 * @date 04/19/2026
 * @brief Handles the logic for creating a WindowManager struct.
 *
 * @param name : c-style string constant
 * @param wSize : Size struct
 * @return A pointer to the newly created WindowManager struct
 */
 ...
 * or not the WindowManager struct in question was successfully
 * destroyed
 */
Error* destroyWindowManager(WindowManager* wManager) {
    ...
    Error* err = NULL;
    if (wManager->errCont) err = destroyErrorContainer(wManager->errCont);
    return err;
}
 ...
 * @param wManager : WindowManager struct pointer
 * @return A pointer to an Error struct that describes whether
 * or not the current scene from the WindowManager struct was
 ...
 * @param wManager: WindowManager struct pointer
 * @return A pointer to an Error struct that describes whether
 * or not the window was successfully created
 */
 ...
 * @param wManager : WindowManager struct pointer
 * @return A pointer to an Error struct that describes whether
 * or not the renderer was successfully created
 */
 ...
 * @param wManager : WindowManager struct pointer
 * @return A pointer to an Error struct that describes whether
 * or not the initialization of the game window was successful
 */
 ...
 * @param wSize : Size struct
 * @return A pointer to an Error struct that describes whether
 * or not the window loop ran into an issue
 */
